...
module.exports = {
    ...
    async findByGoogle(req, res, next) {
        try {
            const email = req.params.email;

            const data = await User.findByGoogle(email);    
            console.log(`Usuario: ${data}`);
            return res.status(201).json(data);
        } 
        catch (error) {
    ...
    async registerWithGoogle(req, res, next) {
        try {
    ...
    async registerWithImageGoogle(req, res, next) {
        try {
